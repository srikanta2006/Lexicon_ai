...
// ─── Advanced Contract Intelligence Features ─────────────────────────────────

export async function compareDiff(documentIds) {
  const response = await api.post('/compare/diff', {
    document_ids: documentIds,
  });
  return response.data;
}

export async function createDealBundle(dealData) {
  const response = await api.post('/deals', dealData);
  return response.data;
}

export async function listDealBundles() {
  const response = await api.get('/deals');
  return response.data;
}

export async function getDealBundle(dealId) {
  const response = await api.get(`/deals/${dealId}`);
  return response.data;
}

export async function deleteDealBundle(dealId) {
  const response = await api.delete(`/deals/${dealId}`);
  return response.data;
}

export async function analyzeDealBundle(dealId) {
  const response = await api.post(`/deals/${dealId}/analyze`);
  return response.data;
}

export async function negotiateChat(negotiateData) {
  const response = await api.post('/negotiate/chat', negotiateData);
  return response.data;
}
